...
function getShows() {
  ...
  // results.innerHTML = ""  // resets the table
   for (let key in showList) {
    if (deletedIndex.includes(key)) continue;

     if (cat == "All" || showList[key].category == cat) {
       rowString += "<tr>";
       rowString += "<td>" + key + "</td>";
       rowString += "<td>" + showList[key]['title'] + "</td>";
       rowString += "<td>" + showList[key].cast.join(", ") + "</td>";
       rowString += "<td>" + showList[key].year + "</td>";rowString += "<td>" + showList[key].ratingScore() + "</td></tr>";
     }
   }
...
function deleteByCategory() {
  ...
  for (let key in showList) {
    if (showList[key].category == cat && !deletedIndex.includes(key)) {
